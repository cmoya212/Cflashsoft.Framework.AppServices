...
namespace Cflashsoft.Framework.EntityCoreAppServices
{
    public class EntityDataContext<TDbContext> : DataContext<TDbContext>, IDisposable, ISaveable where TDbContext : DbContext, new()
    {
        ...
        private static IEntityDataValidator<EntityDataContext<TDbContext>, TDbContext> _defaultValidator = null;
        ...
        /// </summary>
        public static IEntityDataValidator<EntityDataContext<TDbContext>, TDbContext> DefaultValidator
        {
            get
            {
